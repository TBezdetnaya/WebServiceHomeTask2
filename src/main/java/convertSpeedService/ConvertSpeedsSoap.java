...
public interface ConvertSpeedsSoap {
    ...
    @RequestWrapper(localName = "ConvertSpeed", targetNamespace = "http://www.webserviceX.NET/", className = "com.convertSpeedService.ConvertSpeed")
    @ResponseWrapper(localName = "ConvertSpeedResponse", targetNamespace = "http://www.webserviceX.NET/", className = "com.convertSpeedService.ConvertSpeedResponse")
